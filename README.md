...
* Mainnet: Sidecar ([v3.4.0](https://github.com/Layr-Labs/sidecar/releases/tag/v3.4.0))
* Testnet: Sidecar ([v3.4.0](https://github.com/Layr-Labs/sidecar/releases/tag/v3.4.0))
* Preprod: Sidecar ([v3.4.0](https://github.com/Layr-Labs/sidecar/releases/tag/v3.4.0))
